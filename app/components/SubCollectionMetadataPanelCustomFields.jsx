...
var SubCollectionMetadataPanelCustomFields = React.createClass({
  ...
  addMetadataField: function(metadataFieldLabel, metadataFieldValue, path) {
    ...
    // add the metadata field object to the list at the given path to the collection data object in the store
  ...
  updateMetadataFieldValue: function(fieldValue, path) {
    // update the metadata field value for the collection data object in the store
  ...
  deleteMetadataField: function(path, fieldIndex) {
    ...
    // delete the metadata field at the given path and index from the collection data object in the store
